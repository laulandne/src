...
#include <guilib/ARequesterNetwork.h>
...
///////////////////////////////////////////////////////////////////////////////
//  ARequesterNetwork Class
///////////////////////////////////////////////////////////////////////////////

void ARequesterNetwork::init()
{
  ARequestAbstract::init();
  chosenHost=(AHost *)NULL;
}


AHost *ARequesterNetwork::getSelectedHost()
{
  return chosenHost;
}


char *ARequesterNetwork::doTheHardWork(char *name,char *msg)
{
  AHost *returnValue=(AHost *)NULL;
  char *chosenHostName=(char *)"127.0.0.1";
  // FIXME: do the hard work here
  chosenHost=returnValue;
  return chosenHostName;
}
