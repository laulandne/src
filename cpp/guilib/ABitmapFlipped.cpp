...
////////////////////////////////////////////////////////////////////////////////
//  ABitmapFlipped Class
////////////////////////////////////////////////////////////////////////////////

ABitmapFlipped::ABitmapFlipped(ADisplay *someDisplay, ADisplayMode *d) :  APrivateBitmap(someDisplay,d)
{
...
void ABitmapFlipped::draw(ABitmap *source, unsigned int dx, unsigned int dy)
{
  //DEBUG_OUT<<"Draw on ABitmapFlipped!\n";
  ...
  dest=plane[0]+(dy*bytesPerLine)+dx+(drawHeight*bytesPerLine);
...
void ABitmapFlipped::writePixel(unsigned int x, unsigned int y)
{
  if(x>width) x=width;
...
// FIXME: Just a copy of ABitmap::readPixel for now...doesn't handle flipped!
unsigned int ABitmapFlipped::readPixel(unsigned int x, unsigned int y)
{
  if(eightBits) {
