#ifndef BINARYLIB_NPALMAPPDECODER_H
#define BINARYLIB_NPALMAPPDECODER_H
...
class NPalmAppDecoder : public NBinaryDecoder
{
public:
  NPalmAppDecoder();
  ...
  virtual char *which() { return (char *)"NPalmAppDecoder"; }
protected:
  EResourceFile *ersrc;
};
