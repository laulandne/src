#ifndef BINARYLIB_NBUNDLEDECODER_H
#define BINARYLIB_NBUNDLEDECODER_H
...
class NBundleDecoder : public NBinaryDecoder
{
public:
  NBundleDecoder();
  ...
  virtual char *which() { return (char *)"NBundleDecoder"; }
protected:
};
