#ifndef BINARYLIB_NZMACHINEDECODER_H
#define BINARYLIB_NZMACHINEDECODER_H
...
class NZMachineDecoder : public NBinaryDecoder
{
public:
  NZMachineDecoder();
  ...
  virtual char *which() { return (char *)"NZMacineDecoder"; }
  virtual bool decodeNodes();
protected:
  unsigned int highBase,initialPC,dictLoc,objLoc,globalLoc,staticBase,abvLoc;
};
