...
////////////////////////////////////////////////////////////////////////////////
//  EVideoIOBitmap Class
////////////////////////////////////////////////////////////////////////////////

EVideoIOBitmap::EVideoIOBitmap(EHandler *parent,unsigned int ncol,unsigned int nrow, unsigned int depthHint) : EVideoIOAbstract(parent,ncol,nrow,depthHint)
{
  DEBUG_OUT<<"EVideoIOBitmap::EVideoIOBitmap...\n";
}


EVideoIOBitmap::~EVideoIOBitmap()
{
  DEBUG_OUT<<"Destroying EVideoIOBitmap\n";
  if(!err.error()) freeVideo();
  err.set();
}


void EVideoIOBitmap::init()
{
