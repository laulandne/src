  ...
  switch(topcode) {
      case 0x0:   exec_end_tag(loc,opcode);  break;
      case 0x1:   exec_show_frame(loc,opcode);  break;
      case 0x2:   exec_define_shape(loc,opcode);  break;
      case 0x3:   exec_free_character(loc,opcode);  break;
      case 0x4:   exec_place_object(loc,opcode);  break;
      case 0x5:   exec_remove_object(loc,opcode);  break;
      case 0x6:   exec_define_bits(loc,opcode);  break;
      case 0x7:   exec_define_button(loc,opcode);  break;
      case 0x8:   exec_jpeg_tables(loc,opcode);  break;
      case 0x9:   exec_set_background_color(loc,opcode);  break;
      case 0x0A:   exec_define_font(loc,opcode);  break;
      case 0x0B:   exec_define_text(loc,opcode);  break;
      case 0x0C:   exec_do_action(loc,opcode);  break;
      case 0x0D:   exec_define_font_info(loc,opcode);  break;
      case 0x0E:   exec_define_sound(loc,opcode);  break;
      case 0x0F:   exec_start_sound(loc,opcode);  break;
      case 0x10:   exec_stop_sound(loc,opcode);  break;
      case 0x11:   exec_define_button_sound(loc,opcode);  break;
      case 0x12:   exec_sound_stream_head(loc,opcode);  break;
      case 0x13:   exec_sound_stream_block(loc,opcode);  break;
      case 0x14:   exec_define_bits_lossless(loc,opcode);  break;
      case 0x15:   exec_define_bits_jpeg2(loc,opcode);  break;
      case 0x16:   exec_define_shape2(loc,opcode);  break;
      case 0x17:   exec_define_bitton_cxform(loc,opcode);  break;
      case 0x18:   exec_protect(loc,opcode);  break;
      case 0x19:   exec_paths_are_postscript(loc,opcode);  break;
      case 0x1A:   exec_place_object2(loc,opcode);  break;
      case 0x1B:   exec_remove_object2(loc,opcode);  break;
      case 0x1C:   exec_illegal(loc,opcode);  break;
      case 0x1D:   exec_sync_frame(loc,opcode);  break;
      case 0x1E:   exec_illegal(loc,opcode);  break;
      case 0x1F:   exec_free_all(loc,opcode);  break;
      case 0x20:   exec_define_shape3(loc,opcode);  break;
      case 0x21:   exec_define_text2(loc,opcode);  break;
      case 0x22:   exec_define_button2(loc,opcode);  break;
      case 0x23:   exec_define_bits_jpeg3(loc,opcode);  break;
      case 0x24:   exec_define_bits_lossless2(loc,opcode);  break;
      case 0x25:   exec_define_edit_text(loc,opcode);  break;
      case 0x26:   exec_define_video(loc,opcode);  break;
      case 0x27:   exec_define_sprite(loc,opcode);  break;
      case 0x28:   exec_name_character(loc,opcode);  break;
      case 0x29:   exec_serial_number(loc,opcode);  break;
      case 0x2A:   exec_define_text_format(loc,opcode);  break;
      case 0x2B:   exec_frame_label(loc,opcode);  break;
      case 0x2C:   exec_illegal(loc,opcode);  break;
      case 0x2D:   exec_sound_stream_head2(loc,opcode);  break;
      case 0x2E:   exec_define_morph_shape(loc,opcode);  break;
      case 0x2F:   exec_generate_frame(loc,opcode);  break;
      case 0x30:   exec_define_font2(loc,opcode);  break;
      case 0x31:   exec_generator_command(loc,opcode);  break;
      case 0x32:   exec_define_command_object(loc,opcode);  break;
      case 0x33:   exec_character_set(loc,opcode);  break;
      case 0x34:   exec_external_font(loc,opcode);  break;
      case 0x35:   exec_illegal(loc,opcode);  break;
      case 0x36:   exec_illegal(loc,opcode);  break;
      case 0x37:   exec_illegal(loc,opcode);  break;
      case 0x38:   exec_export(loc,opcode);  break;
      case 0x39:   exec_import(loc,opcode);  break;
      case 0x3A:   exec_protect_debug(loc,opcode);  break;
      case 0x3B:   exec_do_init_action(loc,opcode);  break;
      case 0x3C:   exec_define_video_stream(loc,opcode);  break;
      case 0x3D:   exec_video_frame(loc,opcode);  break;
      case 0x3E:   exec_define_font_info2(loc,opcode);  break;
      case 0x3F:   exec_illgeal(loc,opcode);  break;
      case 0x40:   exec_protect_debug2(loc,opcode);  break;
      case 0x41:   exec_script_limits(loc,opcode);  break;
      case 0x42:   exec_set_tab_index(loc,opcode);  break;
      case 0x43:   exec_illegal(loc,opcode);  break;
      case 0x44:   exec_illegal(loc,opcode);  break;
      case 0x45:   exec_illegal(loc,opcode);  break;
      case 0x46:   exec_place_object3(loc,opcode);  break;
      ...
      default:  exec_invalid("ESwf_exec.h"); break;
  }
