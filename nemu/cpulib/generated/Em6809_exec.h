  ...
  switch(topcode) {
      case 0x0:   exec_neg(loc,opcode);  break;
      case 0x1:   exec_illegal(loc,opcode);  break;
      case 0x2:   exec_illegal(loc,opcode);  break;
      case 0x3:   exec_com(loc,opcode);  break;
      case 0x4:   exec_lsr(loc,opcode);  break;
      case 0x5:   exec_illegal(loc,opcode);  break;
      case 0x6:   exec_ror(loc,opcode);  break;
      case 0x7:   exec_asr(loc,opcode);  break;
      case 0x8:   exec_asl(loc,opcode);  break;
      case 0x9:   exec_rol(loc,opcode);  break;
      case 0x0A:   exec_dec(loc,opcode);  break;
      case 0x0B:   exec_illegal(loc,opcode);  break;
      case 0x0C:   exec_inc(loc,opcode);  break;
      case 0x0D:   exec_tst(loc,opcode);  break;
      case 0x0E:   exec_jmp(loc,opcode);  break;
      case 0x0F:   exec_clr(loc,opcode);  break;
      case 0x10:   exec_special(loc,opcode);  break;
      case 0x11:   exec_special(loc,opcode);  break;
      case 0x12:   exec_nop(loc,opcode);  break;
      case 0x13:   exec_unknown(loc,opcode);  break;
      case 0x14:   exec_illegal(loc,opcode);  break;
      case 0x15:   exec_illegal(loc,opcode);  break;
      case 0x16:   exec_lbra(loc,opcode);  break;
      case 0x17:   exec_lbsr(loc,opcode);  break;
      case 0x18:   exec_illegal(loc,opcode);  break;
      case 0x19:   exec_daa(loc,opcode);  break;
      case 0x1A:   exec_orcc(loc,opcode);  break;
      case 0x1B:   exec_unknown(loc,opcode);  break;
      case 0x1C:   exec_andcc(loc,opcode);  break;
      case 0x1D:   exec_sex(loc,opcode);  break;
      case 0x1E:   exec_exg(loc,opcode);  break;
      case 0x1F:   exec_tfr(loc,opcode);  break;
      ...
      case 0x30:   exec_leax(loc,opcode);  break;
      case 0x31:   exec_leay(loc,opcode);  break;
      case 0x32:   exec_leas(loc,opcode);  break;
      case 0x33:   exec_leau(loc,opcode);  break;
      case 0x34:   exec_pshs(loc,opcode);  break;
      case 0x35:   exec_puls(loc,opcode);  break;
      case 0x36:   exec_pshu(loc,opcode);  break;
      case 0x37:   exec_pulu(loc,opcode);  break;
      ...
      case 0x3C:   exec_cwai(loc,opcode);  break;
      ...
      case 0x8E:   exec_ldx(loc,opcode);  break;
      ...
      case 0x9E:   exec_ldx(loc,opcode);  break;
      case 0x9F:   exec_stx(loc,opcode);  break;
      ...
      case 0xBE:   exec_ldx(loc,opcode);  break;
      case 0xBF:   exec_stx(loc,opcode);  break;
      ...
      case 0xCE:   exec_ldu(loc,opcode);  break;
      ...
      case 0xDE:   exec_ldu(loc,opcode);  break;
      case 0xDF:   exec_stu(loc,opcode);  break;
      ...
      case 0xEE:   exec_ldu(loc,opcode);  break;
      case 0xEF:   exec_stu(loc,opcode);  break;
      ...
      case 0xFE:   exec_ldu(loc,opcode);  break;
      case 0xFF:   exec_stu(loc,opcode);  break;
      default:  exec_invalid("Em6809_exec.h"); break;
  }
