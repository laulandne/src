  ...
  switch(topcode) {
      ...
      case 0x0x02:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x03:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x04:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x05:   dis_ora(loc,opcode);  break;  // ora
      case 0x0x06:   dis_asl(loc,opcode);  break;  // asl
      case 0x0x07:   dis_illegal(loc,opcode);  break;  // illegal
      ...
      case 0x0x0b:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x0c:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x0d:   dis_ora(loc,opcode);  break;  // ora
      case 0x0x0e:   dis_asl(loc,opcode);  break;  // asl
      case 0x0x0f:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x10:   dis_bpl(loc,opcode);  break;  // bpl
      case 0x0x11:   dis_ora(loc,opcode);  break;  // ora
      case 0x0x12:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x13:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x14:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x15:   dis_ora(loc,opcode);  break;  // ora
      case 0x0x16:   dis_asl(loc,opcode);  break;  // asl
      case 0x0x17:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x18:   dis_clc(loc,opcode);  break;  // clc
      case 0x0x19:   dis_ora(loc,opcode);  break;  // ora
      case 0x0x1a:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x1b:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x1c:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x1d:   dis_ora(loc,opcode);  break;  // ora
      case 0x0x1e:   dis_asl(loc,opcode);  break;  // asl
      case 0x0x1f:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x20:   dis_jsr(loc,opcode);  break;  // jsr
      case 0x0x21:   dis_and(loc,opcode);  break;  // and
      case 0x0x22:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x23:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x24:   dis_bit(loc,opcode);  break;  // bit
      case 0x0x25:   dis_and(loc,opcode);  break;  // and
      case 0x0x26:   dis_rol(loc,opcode);  break;  // rol
      case 0x0x27:   dis_illegal(loc,opcode);  break;  // illegal
      ...
      case 0x0x2b:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x2c:   dis_bit(loc,opcode);  break;  // bit
      case 0x0x2d:   dis_and(loc,opcode);  break;  // and
      case 0x0x2e:   dis_rol(loc,opcode);  break;  // rol
      case 0x0x2f:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x30:   dis_bmi(loc,opcode);  break;  // bmi
      case 0x0x31:   dis_and(loc,opcode);  break;  // and
      case 0x0x32:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x33:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x34:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x35:   dis_and(loc,opcode);  break;  // and
      case 0x0x36:   dis_rol(loc,opcode);  break;  // rol
      case 0x0x37:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x38:   dis_sec(loc,opcode);  break;  // sec
      case 0x0x39:   dis_and(loc,opcode);  break;  // and
      case 0x0x3a:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x3b:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x3c:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x3d:   dis_and(loc,opcode);  break;  // and
      case 0x0x3e:   dis_rol(loc,opcode);  break;  // rol
      case 0x0x3f:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x40:   dis_rti(loc,opcode);  break;  // rti
      case 0x0x41:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x42:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x43:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x44:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x45:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x46:   dis_lsr(loc,opcode);  break;  // lsr
      case 0x0x47:   dis_illegal(loc,opcode);  break;  // illegal
      ...
      case 0x0x4b:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x4c:   dis_jmp(loc,opcode);  break;  // jmp
      case 0x0x4d:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x4e:   dis_lsr(loc,opcode);  break;  // lsr
      case 0x0x4f:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x50:   dis_bvc(loc,opcode);  break;  // bvc
      case 0x0x51:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x52:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x53:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x54:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x55:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x56:   dis_lsr(loc,opcode);  break;  // lsr
      case 0x0x57:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x58:   dis_cli(loc,opcode);  break;  // cli
      case 0x0x59:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x5a:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x5b:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x5c:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x5d:   dis_eor(loc,opcode);  break;  // eor
      case 0x0x5e:   dis_lsr(loc,opcode);  break;  // lsr
      case 0x0x5f:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x60:   dis_rts(loc,opcode);  break;  // rts
      case 0x0x61:   dis_adc(loc,opcode);  break;  // adc
      case 0x0x62:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x63:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x64:   dis_illegal(loc,opcode);  break;  // illegal
      case 0x0x65:   dis_adc(loc,opcode);  break;  // adc
      case 0x0x66:   dis_ror(loc,opcode);  break;  // ror
      case 0x0x67:   dis_illegal(loc,opcode);  break;  // illegal
