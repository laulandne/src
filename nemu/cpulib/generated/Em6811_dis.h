  ...
  switch(topcode) {
      case 0x0:   dis_test(loc,opcode);  break;  // test
      case 0x1:   dis_nop(loc,opcode);  break;  // nop
      case 0x2:   dis_idiv(loc,opcode);  break;  // idiv
      case 0x3:   dis_fdiv(loc,opcode);  break;  // fdiv
      case 0x4:   dis_lsrd(loc,opcode);  break;  // lsrd
      case 0x5:   dis_asrd(loc,opcode);  break;  // asrd
      ...
      case 0x12:   dis_brset(loc,opcode);  break;  // brset
      case 0x13:   dis_brclr(loc,opcode);  break;  // brclr
      case 0x14:   dis_bset(loc,opcode);  break;  // bset
      case 0x15:   dis_bclr(loc,opcode);  break;  // bclr
      case 0x16:   dis_tab(loc,opcode);  break;  // tab
      case 0x17:   dis_tba(loc,opcode);  break;  // tba
      case 0x18:   dis_special(loc,opcode);  break;  // special
      case 0x19:   dis_daa(loc,opcode);  break;  // daa
      case 0x1A:   dis_special(loc,opcode);  break;  // special
      case 0x1B:   dis_aba(loc,opcode);  break;  // aba
      case 0x1C:   dis_bset(loc,opcode);  break;  // bset
      case 0x1D:   dis_bclr(loc,opcode);  break;  // bclr
      case 0x1E:   dis_brset(loc,opcode);  break;  // brset
      case 0x1F:   dis_brclr(loc,opcode);  break;  // brclr
      ...
      case 0x8E:   dis_lds(loc,opcode);  break;  // lds
      case 0x8F:   dis_xgdx(loc,opcode);  break;  // xgdx
      ...
      case 0x9E:   dis_lds(loc,opcode);  break;  // lds
      case 0x9F:   dis_sts(loc,opcode);  break;  // sts
      ...
      case 0xCD:   dis_special(loc,opcode);  break;  // special
      case 0xCE:   dis_ldx(loc,opcode);  break;  // ldx
      case 0xCF:   dis_stop(loc,opcode);  break;  // stop
      ...
      case 0xDE:   dis_ldx(loc,opcode);  break;  // ldx
      case 0xDF:   dis_stx(loc,opcode);  break;  // stx
      ...
      case 0xEE:   dis_ldx(loc,opcode);  break;  // ldx
      case 0xEF:   dis_stx(loc,opcode);  break;  // stx
      ...
      default:  dis_invalid("Em6811_dis.h"); break;
  }
