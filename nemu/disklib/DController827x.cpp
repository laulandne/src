...
////////////////////////////////////////////////////////////////////////////////
//  DController827x Class
////////////////////////////////////////////////////////////////////////////////

DController827x::DController827x(EHandler *parent,ULONG address) : DControllerAbstract(parent,address)
{
  DEBUG_OUT<<"DController827x::DController827x()\n";
  init();
}


DController827x::~DController827x()
{
}


void DController827x::ioregs()
{
  DEBUG_OUT<<"DController827x @"<<location<<"\n";
  DControllerAbstract::ioregs();
}


void DController827x::io_cycle()
{
  DControllerAbstract::io_cycle();
}


void DController827x::reset()
{
  DControllerAbstract::reset();
}


BYTE DController827x::write8Reg(unsigned int reg,BYTE value)
{
  if(reg>0x0a) {
...
BYTE DController827x::read8Reg(unsigned int reg)
{
  BYTE value=0;
  if(reg>0x0a) {
